"""
Django settings for rough_scene_2 project.
...
ROOT_URLCONF = 'rough_scene_2.urls'
...
WSGI_APPLICATION = 'rough_scene_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rough_scene_2 API",
    "DESCRIPTION": "API documentation for rough_scene_2 App",
    "VERSION": "v1",
}
